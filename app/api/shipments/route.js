      ...
      const [result]=await sql`
        ...
        ON CONFLICT (awb) DO UPDATE SET
          data=EXCLUDED.data || jsonb_build_object(
            ...
            'arrivalDate',COALESCE(NULLIF(EXCLUDED.data->>'arrivalDate',''),mayavi_shipments.data->>'arrivalDate',''),
            'arrivalTime',COALESCE(NULLIF(EXCLUDED.data->>'arrivalTime',''),mayavi_shipments.data->>'arrivalTime',''),
