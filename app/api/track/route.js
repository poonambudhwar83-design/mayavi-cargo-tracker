...
async function handle(mawb){
  ...
  const skipGenericApi=airArabiaOfficialOnly||airIndiaFastPath||qatarFastPath||cathayFastPath||saudiaFastPath||kuwaitFastPath||turkishFastPath||indigoFastPath||omanFastPath||virginFastPath;
  ...
  const skipGenericOcr=mawb.startsWith('065-')||mawb.startsWith('098-')||mawb.startsWith('157-')||mawb.startsWith('160-')||mawb.startsWith('176-')||mawb.startsWith('229-')||mawb.startsWith('235-')||mawb.startsWith('312-')||mawb.startsWith('514-')||mawb.startsWith('910-')||mawb.startsWith('932-');
