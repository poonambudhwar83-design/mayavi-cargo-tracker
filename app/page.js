...
export default function Page(){
 ...
 return <main>
   <section className="hero"><div><div className="eyebrow">MAYAVI CARGO • V3.5</div><h1>Global MAWB Live Tracker</h1><p>Enter one MAWB. Mayavi identifies the airline, checks global cargo data when configured, then uses dedicated official/public carrier adapters. If an airline blocks automation, the correct official tracker stays one click away.</p></div><div className="version">LIVE TRACKING</div></section>
   ...
   <footer>{CONFIGURED_PREFIXES.length} airline prefixes mapped • Dedicated paths: Lufthansa 020 API/public eTracking • Saudia 065 • Cathay 160 • Global API provider ready for remaining carriers</footer>
 </main>
}
