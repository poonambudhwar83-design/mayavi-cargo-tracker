...
function officialUrl(row={}){return airlineForMawb(row.mawb)?.url||row.officialTracker||''}
...
export default function Page(){
 ...
 return <main>
   <section className="hero"><div><div className="eyebrow">MAYAVI CARGO • V3.8.1</div><h1>Global MAWB Live Tracker</h1><p>Shared cloud database + automatic airline tracking. Add or refresh a MAWB once and the same saved row is visible to everyone opening this tracker.</p></div><div className="version">{shared?'SHARED DATABASE ✓':'LOCAL BACKUP'}</div></section>
