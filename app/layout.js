...
export const metadata={title:'Mayavi Cargo V3.9.0 — Global MAWB Tracker',description:'Live MAWB tracking with airline adapters, official browser capture, and automatic Air Arabia result OCR'};
...
export default function RootLayout({children}){return <html lang="en"><body><script dangerouslySetInnerHTML={{__html:qatarSeed}}/>{children}<AirArabiaLiveCapture/></body></html>}
