...
function parseVisibleText(text,mawb,airline){
  ...
  if(iata==='QR'){
    ...
    if(qr.arrivalDate&&!arrivalDate){arrivalDate=qr.arrivalDate;arrivalSource='qatar-result-row';}
    if(qr.arrivalTime&&!arrivalTime){arrivalTime=qr.arrivalTime;arrivalSource='qatar-result-row';}
