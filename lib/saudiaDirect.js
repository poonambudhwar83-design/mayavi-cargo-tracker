...
async function applyFowFlightRule(input,shipment={},salShipment=null){
  ...
  // Show planned arrival as soon as SAL publishes FOW with the final-leg flight number.
  // Do not wait for DEP. Before FOW, keep arrival time blank.
  if(movementCode!=='FOW')return s;
