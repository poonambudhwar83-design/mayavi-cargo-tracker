...
function airIndiaDelArrival(flightNo='',departureDate=''){
 const f=String(flightNo||'').replace(/[^A-Z0-9]/gi,'').toUpperCase();
 ...
 if(f==='AI188'&&departureDate)return{arrivalDate:addDays(departureDate,1),arrivalTime:'13:25',arrivalSource:'AI188 YYZ-DEL schedule'};
 if(f==='AI190'&&departureDate)return{arrivalDate:addDays(departureDate,1),arrivalTime:'20:15',arrivalSource:'AI190 YYZ-DEL schedule'};
 return null;
}
