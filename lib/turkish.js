...
export async function trackTurkish(input) {
  ...
  let browser;
  const debug = { prefix:'235', airline:'Turkish Cargo', url:URL, stage:'OPEN', tkSmartClicked:false, restoredWorkingFlow:true };
  try {
    ...
    // Restored Sep-10 working flow: fill AWB -> Add -> Search directly on the official page.
