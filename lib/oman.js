...
export async function trackOman(input){
  ...
  try{
    ...
    return{ok:true,airline:AIRLINE,shipment,screenshotCaptured:false,screenshotVerified:false,screenshotOcrUsed:false,debug:{stage:'SMARTKARGO_QUERY_SUCCESS_BOTTOM_EVENT',resultUrl:page.url(),latestOfficialEvent:shipment.latestOfficialEvent,textSample:clean(text).slice(0,7000)}};
