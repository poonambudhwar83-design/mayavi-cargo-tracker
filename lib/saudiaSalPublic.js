...
function parseMessage(outer,mawb){
  ...
  if(latestFinalIsActive){
    ...
    arrivalDate=normalizeDateOnly(scheduledArrivalRaw)||normalizeDateOnly(scheduledArrivalDateRaw);arrivalTime=normalizeTimeOnly(scheduledArrivalRaw)||normalizeTimeOnly(scheduledArrivalTimeRaw);if(arrivalDate||arrivalTime)arrivalTimeSource='SAL scheduled/estimated arrival';
  }
