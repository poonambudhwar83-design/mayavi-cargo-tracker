...
export async function trackKuwait(input){
  ...
  try{
    ...
    const origin=rcs.airport||flightEvent.airport||'';
    ...
    return{
      ...
      debug:{stage:'KUWAIT_DETAILS_ONLY',fill,clicked,ops,textSample:extracted.text.slice(0,6000)}
    };
  }catch(e){
