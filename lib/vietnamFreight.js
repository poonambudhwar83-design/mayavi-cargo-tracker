...
function parseShipment(payload,mawb){
  ...
  const origin=airportCode(item.origin)||codeFrom(item.origin);
  ...
  return{
    ...
    finalFlightNo:finalLeg.flightNo||'',
    finalFlightDate:finalLegDate,
    finalFlightOrigin:finalLeg.origin||via||'',
    finalFlightDestination:finalLeg.destination||destination||'',
    ...
    departureFlightNo:originDeparture.flightNo||'',
    departureOrigin:originDeparture.origin||origin,
    departureDestination:originDeparture.destination||via||'',
