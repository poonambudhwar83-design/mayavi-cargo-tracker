export const AIRLINES = {
  ...
  '065': { name: 'Saudia Cargo', iata: 'SV', region: 'Saudi Arabia / Jeddah', url: 'https://saudiacargo.com/en/digital-services', priority: true },
  ...
  '098': { name: 'Air India Cargo', iata: 'AI', region: 'India', url: 'https://aicargoportal.airindia.com/icargoneoportal/app/main/#/app', priority: true },
  ...
  '131': { name: 'Japan Airlines Cargo', iata: 'JL', region: 'Japan / Asia', url: 'https://www.jal.co.jp/jp/en/jalcargo/' },
  ...
  '176': { name: 'Emirates SkyCargo', iata: 'EK', region: 'Dubai / UAE', url: 'https://eskycargo.emirates.com/app/offerandorder/#/home/find-offer', priority: true },
  '180': { name: 'Korean Air Cargo', iata: 'KE', region: 'Korea / Asia', url: 'https://cargo.koreanair.com/en/tracking' },
  '205': { name: 'ANA Cargo', iata: 'NH', region: 'Japan / Asia', url: 'https://www.anacargo.jp/en/int/' },
  '217': { name: 'THAI Cargo', iata: 'TG', region: 'Bangkok / Thailand', url: 'https://www.thaicargo.com/en/tracking', priority: true },
  '229': { name: 'Kuwait Airways Cargo', iata: 'KU', region: 'Kuwait', url: 'https://www.kuwaitairways.com/en/cargo/tracking', priority: true },
  '232': { name: 'Malaysia Airlines Cargo', iata: 'MH', region: 'Malaysia', url: 'https://www.maskargo.com/', priority: true },
  '235': { name: 'Turkish Cargo', iata: 'TK', region: 'Türkiye / Europe', url: 'https://turkishcargo.com/en/cargo-tracking', priority: true },
  '297': { name: 'China Airlines Cargo', iata: 'CI', region: 'Taiwan', url: 'https://cargo.china-airlines.com/ccnetv2/content/manage/ShipmentTracking.aspx' },
  '312': { name: 'IndiGo CarGo', iata: '6E', region: 'India', url: 'https://becargo.goindigo.in/FrmAWBTracking.aspx', priority: true },
  '406': { name: 'UPS Airlines', iata: '5X', region: 'USA', url: 'https://www.ups.com/track' },
  '514': { name: 'Air Arabia Cargo', iata: 'G9', region: 'Sharjah / UAE', url: 'https://airarabia-g9.ibsplc.aero/icargoneoportal/app/main/#/app', priority: true },
  '603': { name: 'SriLankan Cargo', iata: 'UL', region: 'Sri Lanka / Asia', url: 'https://www.srilankancargo.com/', priority: true },
  '607': { name: 'Etihad Cargo', iata: 'EY', region: 'Abu Dhabi / UAE', url: 'https://www.etihadcargo.com/en/e-services/shipment-tracking', priority: true },
  '618': { name: 'Singapore Airlines Cargo', iata: 'SQ', region: 'Singapore', url: 'https://www.siacargo.com/' },
  '695': { name: 'EVA Air Cargo', iata: 'BR', region: 'Taiwan', url: 'https://www.brcargo.com/' },
  '738': { name: 'Vietnam Airlines Cargo', iata: 'VN', region: 'Vietnam', url: 'https://cargo.vietnamairlines.com/vn/en/shipping-guide/track-your-cargo' },
  '775': { name: 'SpiceJet Cargo', iata: 'SG', region: 'India', url: 'https://corporate.spicejet.com/Cargo.aspx' },
  '781': { name: 'China Eastern Cargo', iata: 'MU', region: 'China', url: 'https://cargo.ceair.com/' },
  '784': { name: 'China Southern Cargo', iata: 'CZ', region: 'China', url: 'https://cargo.csair.com/pages/cargotracking' },
  '816': { name: 'Batik Air Malaysia', iata: 'OD', region: 'Malaysia', url: 'https://www.batikair.com/', priority: true },
  '910': { name: 'Oman Air Cargo', iata: 'WY', region: 'Oman', url: 'https://cargo.omanair.com/track-shipment', priority: true },
  ...
  '978': { name: 'VietJet Cargo', iata: 'VJ', region: 'Vietnam', url: 'https://www.vietjetair.com/' },
  '999': { name: 'Air China Cargo', iata: 'CA', region: 'China', url: 'https://www.airchinacargo.com/' }
};
