...
function parseVirgin(summaryText='',trackingText='',mawb=''){
  ...
  if(destination){
    ...
    if(arr){actualArrivalTime=timeOnly(arr[1]);actualArrivalDate=dateOnly(arr[2],year);arrivalIsActual=true;if(!arrivalDate||!arrivalTime){arrivalTime=actualArrivalTime;arrivalDate=actualArrivalDate;arrivalSource='ARR';}}
  }
