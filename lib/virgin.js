...
function parseVirgin(summaryText='',trackingText='',mawb=''){
  ...
  return{shipment:{mawb,carrierCode:'VS',airlineName:'Virgin Atlantic Cargo',officialTracker:URL,origin,destination,bags:pieces,pieces,weight,flightNo,bookingDate,bookingTime,arrivalDate,arrivalTime,arrivalIsActual,status,arrivalSource,actualArrivalDate,actualArrivalTime,source:`Virgin Atlantic Cargo → ${arrivalSource||'Tracking Details'} priority arrival + Tracking Details status`}};
}
